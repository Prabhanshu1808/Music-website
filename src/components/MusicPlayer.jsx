    ...
    <div className="musicPlayer flex flex-col px-5 w-[100%]  border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
        ...
        <div className="upperpart flex items-center justify-between ">
            ...
            <div className="profile flex">
                <img src={require("../image/Mask Group 23.png")} alt="" className='w-[2.5rem] h-[2.5rem] border-2 border-white 
                rounded-full' />
                {/* details */}
              <div className="details flex flex-col ml-4">
                  <span className='text-[1rem]'>Love Me Like you do.</span>
                  <span className='text-sm text-gray-500'>Unknown Artist</span>
              </div>
            </div>

            <div>
                <img src={require("../image/path.png")} alt=""  className='h-[1rem]'/>
            </div>
        </div>
        {/* lower Part */}
        <div className="lowerpart flex items-center justify-between mt-5">
            <div className="track flex justify-between text-sn text-gray-500 flex-[2] items-center">
                <span className=''>2: 30</span>
                <img src={require("../image/Group 9.png")} alt="" className='w-[16rem]'/>
                <span>4: 30</span>
            </div>
            {/* controls */}
